...
const FaceRecognition2Screen: React.FC = () => {
  ...
  const handleConfirmPress = () => {
    navigation.navigate('TakeaTestAfterUserCreated');
  };
...
justifyContent: "center"    }}>
      <Text style={styles.subtitle}>Step 5/5: Parent facial recognition</Text>
...
export default FaceRecognition2Screen;
